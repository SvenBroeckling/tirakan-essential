...
\begin{titlepage}
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[
      ...
      align=center
    ] at (titlepos) {\booktitle};
    \begin{scope}[white, line width=0.8pt]
      \coordinate (linecenter) at ([yshift=-1.0cm]titlepos);
    ...
    \node[
      ...
      align=center
    ] at ([yshift=-1.8cm]linecenter) {\booksubtitle};
    \node[
      text=white,
      font=\displayfont\large\selectfont,
      align=center
    ] at ([yshift=-3.0cm]linecenter) {Version \tirakanversion};
  \end{tikzpicture}
\end{titlepage}
...
\include{chapters/08_magie_und_glaube}
\include{chapters/09_fortschritt}
\include{chapters/10_spielleitung}
\include{chapters/11_glossar}

\appendix
\include{chapters/12_anhang_marks}
\include{chapters/13_anhang_ausruestung}
\include{chapters/14_anhang_zauber}
\include{chapters/15_anhang_boegen}
