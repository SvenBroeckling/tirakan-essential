...
\begin{multicols*}{2}
\section{Zwei übernatürliche Motoren}
Das Spiel trennt bewusst zwischen:
\begin{itemize}[leftmargin=*]
\item \textbf{Zauberei}\index{Zauberei}: wiederholbare, technische Zauberei
\item \textbf{Belief}\index{Belief}: Bitte, Ritus und Antwort höherer Mächte
\end{itemize}

Beide sind gefährlich und teuer, funktionieren aber nicht gleich.
...
\item \textbf{Ritual Cast}\index{Ritual Cast}: 2+ Actions oder ein Downtime-Segment, wenn Vorbereitung, Kreise, Hilfen oder Material nötig sind
\end{itemize}
...
\item \textbf{Verbotene Methode}\index{Verbotene Methode}: senkt Zauberkosten um 1, mindestens auf 1, verursacht aber 1 Corruption
\end{itemize}
