...
\item \textbf{Belief}\index{Belief}: Bitte, Ritus und Antwort hoherer Machte
\end{itemize}
...
\item \textbf{Ritual Cast}\index{Ritual Cast}: 2+ Actions oder ein Downtime-Segment, wenn Vorbereitung, Kreise, Hilfen oder Material notig sind
\end{itemize}
...
\item[\textbf{12--15 Intercession}]\index{Intercession} spurbare Wunderwirkung im Rahmen der Szene
\item[\textbf{16+ Theophany}]\index{Theophany} groBer Eingriff, fremd und verstorend
\end{description}
...
\begin{itemize}[leftmargin=*]
\item \textbf{Relikt}\index{Relikt}: speichert 1--3 Arcana oder Gunst und ubertragt sie durch Beruhrung oder Ritus
