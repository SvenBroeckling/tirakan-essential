...
\section{Waffen}\label{sec:waffen}
...
\subsection{Eigenschaften}\label{subsec:eigenschaften}
\begin{description}[style=nextline,leftmargin=0pt]
...
\section{Rüstung}\label{sec:rustung}
...
\section{Schilde}\label{sec:schilde}
...
\section{Deckung}\label{sec:deckung}
