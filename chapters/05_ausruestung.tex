...
\textbf{Ausrüstung}\index{Ausrustung} gibt einem Charakter Werkzeuge, Reichweite und Schutz.
...
\item[\textbf{Schaden}]\index{Schaden} Grundschaden eines erfolgreichen Treffers
...
\begin{description}[style=nextline,leftmargin=0pt]
\item[\textbf{Schutz}]\index{Schutz} Reduziert eingehenden Schaden einmalig: Finaler Schaden = Schaden - Schutz (Minimum 0)
\item[\textbf{Last}] Bewegungs- und Schleichbelastung
\item[\textbf{Versiegelung}]\index{Versiegelung} Schutz gegen Schock und Aufreißen
\end{description}
...
\section{Schilde}
\textbf{Schilde}\index{Schild} werden als Reaktion genutzt und kosten immer 1 Aktion.
...
\section{Deckung}
\textbf{Deckung}\index{Deckung} funktioniert nur gegen Fernangriffe.
\begin{itemize}[leftmargin=*]
