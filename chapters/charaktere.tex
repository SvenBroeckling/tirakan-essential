...
\begin{itemize}[leftmargin=*]
    ...
    \item acht Attributen
    \item Fertigkeiten aus Abstammung und Weg
...
\item[\textbf{Instinkt}] Schnelle Reflexe in Gefahrensituationen, ein natürlicher Sinn für drohende Bedrohungen und unmittelbares Bauchgefühl unter Druck
...
\item[\textbf{Gabe}] Natürliche magische Begabung, Resonanz mit den magischen Kräften Tirakans und die Fähigkeit, Magie gezielt zu lenken
\item[\textbf{Wahrnehmung}] Schärfe der Sinne, Aufmerksamkeit für kleine Details sowie die Fähigkeit, Spuren, Bewegungen und Veränderungen frühzeitig zu bemerken
\end{description}
...
\item drei Attribute auf 1
\item zwei Attribute auf 0
\end{itemize}
...
Ein Charakter hat keine allgemeine feste Fertigkeitenliste.
Stattdessen ergeben sich seine Start-Fertigkeiten aus der gewählten \textbf{Abstammung} und dem gewählten \textbf{Weg}.
Sobald diese in Schritt 5 feststehen, übernimmst du alle dort aufgeführten Fertigkeiten auf deinen Bogen.

Setze:
\begin{itemize}[leftmargin=*]
\item eine Fertigkeit auf Rang 3
\item drei Fertigkeiten auf Rang 2
\item alle übrigen auf 1
\end{itemize}
...
\item einen \textbf{Weg} (Notiere Vorteil und Verwundbarkeit, Wegfacetten werden erst zum Wachstum wichtig)
\item eine \textbf{Bindung}
\end{itemize}

Mit Abstammung und Weg erhält dein Charakter auch seine Fertigkeiten.
Trage alle dort aufgeführten Fertigkeiten ein und verteile anschließend die Start-Ränge aus Schritt 4 auf diese Liste.
...
\subsubsection{Wundschwelle}
$3 + \text{Körper}$\index{Wundschwelle}
...
Ein Charakter mit Gabe >= 1 ist magisch begabt.
Je nach Höhe der Gabe können Aspekte und Zauber gewählt werden.

\textbf{Gabe:}
\begin{itemize}[leftmargin=*]
\item bei Gabe >= 1: ein Aspekt wählen
\item bei Gabe >= 2: zwei Aspekte wählen
\item Startzauber: 2 + Gabe, maximal 5
\end{itemize}

Wenn dein Charakter begabt ist, wähle einen Fokus (siehe \cref{subsec:fokus}) und ein Regenerationsritual (siehe \cref{subsec:regenerationsritual}).
...
\subsubsection{Aneignen}\index{Aneignen}
\[
\text{Geist oder Erscheinung}
\]
...
\subsubsection{Beschaffen}\index{Beschaffen}
\[
\text{Geist oder Erscheinung}
\]
...
\subsubsection{Trainieren}\index{Traineren}
\[
\text{Wille}
\]
...
\subsubsection{Kontakte pflegen}\index{Kontakte pflegen}
\[
\text{Erscheinung oder Wille}
\]
...
\subsubsection{Ritualvorbereitung}\index{Ritualvorbereitung}
\[
...
\subsection{Auffüllen von Ressourcen}
Am Ende der Auszeit:
\begin{itemize}[leftmargin=*]
