...
\item \textbf{Anrufung}\index{Anrufung} werfen:
\[
...
\item[\textbf{1--7 Stille}]\index{Stille} keine direkte Intervention, nur Zeichen oder Schweigen
\item[\textbf{8--11 Zeichen}]\index{Zeichen} symbolische Antwort, Warnung, Hinweis oder kurzer Schutz
\item[\textbf{12--15 Eingreifen}]\index{Eingreifen} spürbare Wunderwirkung im Rahmen der Szene
\item[\textbf{16+ Offenbarung}]\index{Offenbarung} großer Eingriff, fremd und verstörend
\end{description}

Gunst wird immer verbraucht. Bei \textbf{Stille} unter Tabubruch gibt es +1 Burden. Bei \textbf{Offenbarung} wählt die Spielleiterin einen heiligen Preis: Gelübde, Stigma oder Omen-Schuld.

\section{Anrufungsformen}
\subsection{Stoßgebet}\index{Stoßgebet}
\begin{itemize}[leftmargin=*]
\item Auslöser: unmittelbare Gefahr
\item Dauer: 1 Aktion
\item Kosten: 1--2 Gunst
\item Wirkung: unmittelbare Standfestigkeit, Flucht, Warnung, Schutz oder Wucht
\end{itemize}
Bei \textbf{Zeichen}: +Faith Level auf einen sofortigen Test oder eine eingehende Konsequenz um eine Stufe senken.\\
Bei \textbf{Eingreifen}: zwei solche Boons.\\
Bei \textbf{Offenbarung}: die Szene kippt deutlich zugunsten der Gruppe, aber der Preis folgt.
...
\end{itemize}
Zeichen wirkt bis zum Szenenende, Eingreifen bis zur nächsten vollständigen Rast, Offenbarung kann hartnäckige Flüche brechen oder heiligen Boden schaffen.

\subsection{Geringe Bitte}\index{Geringe Bitte}
\begin{itemize}[leftmargin=*]
...
\end{itemize}
Bei \textbf{Zeichen} gibt es ein klares Omen, eine Warnung, einen Weg oder kurzen Schutz.\\
Bei \textbf{Eingreifen} geschieht ein konkretes Wunder auf Szenenmaßstab.\\
Bei \textbf{Offenbarung} kippt die ganze Szene zugunsten der Bittenden, aber in verstörender oder unheimlicher Form.

\subsection{Große Anrufung}\index{Große Anrufung}
\begin{itemize}[leftmargin=*]
...
Bei \textbf{Zeichen} kommen Furchtzeichen, Gewissheit oder ein zwingender Auftrag über die Szene.\\
Bei \textbf{Eingreifen} greift ein großes Wunder über Menge, Stadtteilrand, Schlachtfeldkante oder entweihten Ort.\\
Bei \textbf{Offenbarung} manifestiert sich eine szenenbestimmende Rettung, Verwandlung oder Verdammnis und fordert trotzdem einen heiligen Preis.

\section{Verbotene Praxis und Relikte}
\begin{itemize}[leftmargin=*]
\item \textbf{Relikt}\index{Relikt}: speichert 1--3 Arkana oder Gunst und überträgt sie durch Berührung oder Ritus
\item \textbf{Verbotene Praxis}\index{Verbotene Praxis}: senkt Zauberkosten um 1, mindestens auf 1, verursacht aber 1 Verderbnis
\end{itemize}
