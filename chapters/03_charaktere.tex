...
\begin{description}[style=nextline,leftmargin=0pt,itemsep=0.2em]
    \item[Wundenschwelle] $3 + \text{Körper}$\index{Wundenschwelle}
    \item[Bürdenschwelle] $5 + \lfloor \text{Wille} / 2 \rfloor$
    \item[Initiative Zielwurf] $30 + (\text{Geschick} \times 10) + (\text{Wahrnehmung} \times 10)$\index{Initiative}
    \item[Omen] $2 + \lfloor \text{Glaubensniveau} / 2 \rfloor$
    \item[Zauberverstärkung] $\text{Magieniveau}$\index{Zauberverstärkung}
    \item[Anrufungswert] $\text{Glaubensniveau} + \text{Ritus}$\index{Anrufungswert}
