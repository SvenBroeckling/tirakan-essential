...
\begin{multicols*}{2}
\section{Grundsatz}
Fortschritt\index{Fortschritt} belohnt uberstandene Kosten, Verwundbarkeit und Reputation, nicht stumpfes Wiederholen.
...
\section{Downtime}
Zwischen groBen Einsätzen erhalt jeder Charakter \textbf{2 Downtime-Actions}\index{Downtime}.
