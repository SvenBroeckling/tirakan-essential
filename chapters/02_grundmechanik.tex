...
Eine Probe wird immer auf einen Wert geworfen, der sich entweder aus einem \textbf{Attribut}\index{Attribut} und einer \textbf{Fertigkeit}\index{Fertigkeit} oder zwei Attributen zusammen setzt.
...
Zu den Attributen zählen \textbf{Geist}, \textbf{Wille}, \textbf{Instinkt}, \textbf{Geschick}, \textbf{Körper}, \textbf{Erscheinung} und \textbf{Gabe}.

Welche Fertigkeiten ein Charakter besitzt, ergibt sich bei der Erschaffung aus seiner Abstammung und seinem Weg.
...
Eine Probe wird weiterhin auf das passende Attribut abgelegt. Eine passende Fertigkeit verändert nicht zwingend den Zielwert, sondern den Umgang mit Erfolg, Fehlschlag und Konsequenzen.

Hat ein Charakter keine passende Fertigkeit, kann er einfache Handlungen trotzdem versuchen. Solche Proben gelten als improvisiert. Die Spielleiterin kann komplexe, gefährliche oder spezialisierte Anwendungen ausschließen oder mit zusätzlichen Konsequenzen verbinden.
...
Der Charakter zählt zu den wenigen herausragenden Könnern seines Fachs. Einmal pro Szene darf er eine Konsequenz aus einer passenden Probe vollständig negieren.
