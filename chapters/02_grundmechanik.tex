...
Die Probe ist der zentrale Bestandteil der Regeln.
...
Eine Probe wird immer auf einen Wert geworfen, der sich aus einem \textbf{Attribut} und einer \textbf{Fertigkeit} zusammen setzt.
...
Dieser \textbf{Zielwert} muss unterschritten werden, damit die Probe erfolgreich ist.
...
Jede misslungene Probe kann zu Konsequenzen führen, die über die eigentliche Intention der Probe hinaus gehen.
...
\item Beide scheitern mit 10+ Differenz: die geringere Fehlmarge bekommt die \textbf{Oberhand}.
...
\textbf{Omen} ist eine gemeinsame Ressource der Gruppe.
...
+1 Omen wird gewonnen, wenn eine groBe Komplikation aus Schwäche, Eid, Schuld oder Verwundbarkeit akzeptiert wird oder wenn eine Bindung mit wirklichem Preis ausgetragen wird.
\end{multicols*}
