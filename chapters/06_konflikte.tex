...
\begin{itemize}[leftmargin=*]
\item Nahkampf: \textbf{Körper} + \textbf{Kampf}
\item Fernkampf: \textbf{Geschick} + \textbf{Schießen}
\end{itemize}

Wenn der Verteidiger eine Aktion übrig hat, kann er mit folgenden Aktionen reagieren.

\begin{itemize}[leftmargin=*]
\item \textbf{Parieren}: \textbf{Instinkt} + \textbf{Kampf}
\item \textbf{Ausweichen}: \textbf{Geschick} + \textbf{Athletik}
