...
Dann wirft jeder Teilnehmer auf sein \textbf{Geschick} und alle Spielercharaktere auf ihre \textbf{Schnellreaktionen}.
...
Hierzu wird eine Probe auf \textbf{Geschick} abgelegt.
...
Hierzu werfen die Spieler auf \textbf{Instinkt}\index{Schnellreaktion}.
...
\begin{itemize}[leftmargin=*]
\item Nahkampf: meist \textbf{Körper}
\item Fernkampf: meist \textbf{Geschick}
\end{itemize}

Passende Kampffertigkeiten wie \textbf{Kampf} oder \textbf{Schießen} verändern den Zielwert nicht, ihre Rangvorteile gelten aber wie üblich.

Wenn der Verteidiger eine Aktion übrig hat, kann er mit folgenden Aktionen reagieren.

\begin{itemize}[leftmargin=*]
\item \textbf{Parieren}: meist \textbf{Instinkt}
\item \textbf{Ausweichen}: meist \textbf{Geschick}
...
Ihre Regeln stehen gesammelt in \cref{ch:wunden}.
